...
struct Thread
{
	...
	Alt		*alts;		/* pointer to current alt structure (debugging) */
...
Proc*	_newproc(int, void*, void**, uint, char*, int, int);
int	_procsplhi(void);
void	_procsplx(int);
void	_sched(void);
...
void	_threadexitsnil(void);
void	_threadflagrendez(Thread*);
Proc*	_threadgetproc(void);
void	_threadsetproc(Proc*);
void	_threadinitstack(Thread*, int, void *, void *);
